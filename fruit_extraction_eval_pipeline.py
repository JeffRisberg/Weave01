...
"there are fruits called pounits are a bright green color and are more savory than sweet.",
...
def fruit_name_score(target: dict, model_output: dict) -> dict:
  print(target['fruit'])
  print(model_output['fruit'])
  return {'correct': target['fruit'].lower() == model_output['fruit'].lower()}
